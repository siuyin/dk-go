...
ADD https://download.docker.com/linux/static/stable/x86_64/docker-20.10.17.tgz /
RUN tar -C /usr/local/bin -xf /docker-20.10.17.tgz --strip-components=1 docker/docker
