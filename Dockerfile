...
ADD https://download.docker.com/linux/static/stable/x86_64/docker-18.03.1-ce.tgz /
RUN tar -C /usr/local/bin -xf /docker-18.03.1-ce.tgz --strip-components=1 docker/docker
