...
ADD https://download.docker.com/linux/static/stable/x86_64/docker-19.03.2-ce.tgz /
RUN tar -C /usr/local/bin -xf /docker-19.03.2-ce.tgz --strip-components=1 docker/docker
